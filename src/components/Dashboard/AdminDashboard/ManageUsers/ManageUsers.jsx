...
const ManageUsers = () => {
    ...
    const { data: users = [], refetch } = useQuery(['users'], async () => {
        try {
            const res = await axios.get('https://summer-camp-server-main.vercel.app/users', {
                headers: {
    ...
    const handelMakeInstructor = (user) => {
        fetch(`https://summer-camp-server-main.vercel.app/users/instructor/${user._id}`, {
            method: 'PATCH'
        })
            .then(res => res.json())
            .then(data => {
    ...
    const handelMakeAdmin = (user) => {
        fetch(`https://summer-camp-server-main.vercel.app/users/admin/${user._id}`, {
            method: 'PATCH'
        })
            .then(res => res.json())
            .then(data => {
