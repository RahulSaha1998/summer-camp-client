...
const ManageClass = () => {
    ...
    const { data: cart = [], refetch } = useQuery(['class'], async () => {
        const res = await axios.get('https://summer-camp-server-side-five.vercel.app/class', {
            headers: {
    ...
    const handleUpdateFeedback = async () => {
        try {
            const res = await axios.patch(
                `https://summer-camp-server-side-five.vercel.app/users/feedback/${selectedItemId}`,
                { feedback }
            );
    ...
    const handelApproved = (item) => {
        fetch(`https://summer-camp-server-side-five.vercel.app/users/status/${item._id}`, {
            method: 'PATCH',
    ...
    const handelDenied = (item) => {
        fetch(`https://summer-camp-server-side-five.vercel.app/users/denied/${item._id}`, {
            method: 'PATCH',
